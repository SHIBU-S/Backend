...
// app.post("InsertCategoryDatas",async(req,res)=>{
//     const {Categoryname,CategoryDescription,CategorySalary,CategoryLocation,CategoryImage} = req.body;
//     try{
//         const newDatas = new Category_Datas({Categoryname,CategoryDescription,CategorySalary,CategoryLocation,CategoryImage});
//         await newDatas.save();
